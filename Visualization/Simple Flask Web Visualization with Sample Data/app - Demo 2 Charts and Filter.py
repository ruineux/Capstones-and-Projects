...
<body>
    ...
    <script>
        ...
        function updateCharts() {
            ...
            document.getElementById('sales-chart-container').style.display = selectedValue === 'all' || selectedValue === 'sales' ? 'block' : 'none';
            document.getElementById('revenue-chart-container').style.display = selectedValue === 'all' || selectedValue === 'revenue' ? 'block' : 'none';
        }
    </script>
</body>
</html>
